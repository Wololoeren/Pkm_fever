...
**516 of them**, of which 278 are machines. The other 238 are below.
...
arrives — ten have returned with the status moves honoured since — and
...
| Machines | 278 | Teaches a move, and keeps |
